<h1>3254. Find the Power of K-Size Subarrays I</h1>
...
<p>You need to find the <strong>power</strong> of all <span data-keyword="subarray-nonempty" class=" cursor-pointer relative text-dark-blue-s text-sm"><div class="popover-wrapper inline-block" data-headlessui-state=""><div><div aria-expanded="false" data-headlessui-state="" id="headlessui-popover-button-:r1h:"><div>subarrays</div></div><div style="position: fixed; z-index: 40; inset: 0px auto auto 0px; transform: translate(273px, 401px);"></div></div></div></span> of <code>nums</code> of size <code>k</code>.</p>
